...
def admin_dashboard():
    ...
    st.markdown("""
        <div style="background: linear-gradient(135deg, #0f172a 0%, #1e293b 100%); padding: 2rem; border-radius: 20px; color: white; margin-bottom: 2rem; box-shadow: var(--shadow-lg);">
            <h1 style="margin: 0; color: white; font-family: 'Outfit', sans-serif;">Painel do Administrador</h1>
            <p style="opacity: 0.8; margin: 10px 0 0 0;">Gestão global de usuários e monitoramento de sistema.</p>
        </div>
    """, unsafe_allow_html=True)
